...
{
    public class ArapTranslatorProduct
    {
        public void Translator(IWebDriver driver, Product pro)
        {
            ...
            ArapProduct producta = new ArapProduct();
            Thread.Sleep(2000);

            producta.Name = pro.Name;
            producta.Description = pro.Description;
            producta.ProductID = pro.ID;
            producta.LanguageCode = "ar-ar";
            producta.State = true;
            string NameA = pro.Name.Trim();
            ...
            string value21 = value11.Replace("&amp;", "&");
            EngName2 = value21;
            ...
            if (!string.IsNullOrWhiteSpace(DescriptionA))
            {
                ...
                if (EngDescription != EngName2)
                {
                    ...
                    string value23 = value13.Replace("&amp;", "&");
            ...
            contex.ArapProducts.Add(producta);
            contex.SaveChanges();
